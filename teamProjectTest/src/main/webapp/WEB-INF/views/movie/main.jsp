    ...
    <div class="movie-container">
      ...
      <!-- 영화 카드 샘플 1 -리뷰작성란 -->
        ...
        <div class="movie-card" style="border: 1px solid black;">
            <img class="movie-poster" src="https://via.placeholder.com/200x300.png?text=Movie+1" alt="Movie 1">
            <div class="movie-info" >
                <div class="movie-title">영화 제목 2</div>
                <div class="movie-genre">액션, 드라마</div>
                <a class="details-button" href="#">자세히 보기</a>
            </div>
      <!-- 영화 카드 샘플 2 -리뷰작성란 -->
            <img class="movie-review" src="https://via.placeholder.com/200x300.png?text=Movie+2" alt="Review 1 chart">
            <div class="movie-info">
                <div class="movie-title">영화 2 리뷰</div>
                <a class="details-button" href="#">리뷰 내역  보기</a>
            </div>
        </div>
        ...
        <div class="movie-card" style="border: 1px solid black;">
            <img class="movie-poster" src="https://via.placeholder.com/200x300.png?text=Movie+1" alt="Movie 1">
            <div class="movie-info" >
                <div class="movie-title">영화 제목 3</div>
                <div class="movie-genre">액션, 드라마</div>
                <a class="details-button" href="#">자세히 보기</a>
            </div>
      <!-- 영화 카드 샘플 3 -리뷰작성란 -->
            <img class="movie-review" src="https://via.placeholder.com/200x300.png?text=Movie+2" alt="Review 1 chart">
            <div class="movie-info">
                <div class="movie-title">영화 3 리뷰</div>
                <a class="details-button" href="#">리뷰 내역  보기</a>
            </div>
        </div>
        ...
        <div class="movie-card" style="border: 1px solid black;">
            <img class="movie-poster" src="https://via.placeholder.com/200x300.png?text=Movie+1" alt="Movie 1">
            <div class="movie-info" >
                <div class="movie-title">영화 제목 4</div>
                <div class="movie-genre">액션, 드라마</div>
                <a class="details-button" href="#">자세히 보기</a>
            </div>
      <!-- 영화 카드 샘플 4 -리뷰작성란 -->
            <img class="movie-review" src="https://via.placeholder.com/200x300.png?text=Movie+2" alt="Review 1 chart">
            <div class="movie-info">
                <div class="movie-title">영화 4 리뷰</div>
                <a class="details-button" href="#">리뷰 내역  보기</a>
            </div>
        </div>
        ...
        <div class="movie-card" style="border: 1px solid black;">
            <img class="movie-poster" src="https://via.placeholder.com/200x300.png?text=Movie+1" alt="Movie 1">
            <div class="movie-info" >
                <div class="movie-title">영화 제목 5</div>
                <div class="movie-genre">액션, 드라마</div>
                <a class="details-button" href="#">자세히 보기</a>
            </div>
      <!-- 영화 카드 샘플 5 -리뷰작성란 -->
            <img class="movie-review" src="https://via.placeholder.com/200x300.png?text=Movie+2" alt="Review 1 chart">
            <div class="movie-info">
                <div class="movie-title">영화 5 리뷰</div>
                <a class="details-button" href="#">리뷰 내역  보기</a>
            </div>
        </div>
        ...
        <div class="movie-card" style="border: 1px solid black;">
            <img class="movie-poster" src="https://via.placeholder.com/200x300.png?text=Movie+1" alt="Movie 1">
            <div class="movie-info" >
                <div class="movie-title">영화 제목 6</div>
                <a class="details-button" href="#">자세히 보기</a>
            </div>
      <!-- 영화 카드 샘플 6 -리뷰작성란 -->
            <img class="movie-review" src="https://via.placeholder.com/200x300.png?text=Movie+2" alt="Review 1 chart">
            <div class="movie-info">
                <div class="movie-title">영화 6 리뷰</div>
                <a class="details-button" href="#">리뷰 내역  보기</a>
            </div>
        </div>
        ...
        <div class="movie-card" style="border: 1px solid black;">
            <img class="movie-poster" src="https://via.placeholder.com/200x300.png?text=Movie+1" alt="Movie 1">
            <div class="movie-info" >
                <div class="movie-title">영화 제목 7</div>
                <div class="movie-genre">액션, 드라마</div>
                <a class="details-button" href="#">자세히 보기</a>
            </div>
      <!-- 영화 카드 샘플 7 -리뷰작성란 -->
            <img class="movie-review" src="https://via.placeholder.com/200x300.png?text=Movie+2" alt="Review 1 chart">
            <div class="movie-info">
                <div class="movie-title">영화 7 리뷰</div>
                <a class="details-button" href="#">리뷰 내역  보기</a>
            </div>
        </div>
